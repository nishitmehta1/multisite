...
function peony_scripts() {
   ...
   $woocommerce_icon_font_size    = absint(peony_option('woocommerce_icon_font_size'));
	...
	.peony .mpl-person:hover .person-vcard,
    ...
    <div class="container">
        <hgroup class="page-title text-light">
            ...
            <?php elseif ($title_bar_type == 1) : ?>
                ...
                <?php echo strlen($post_title)>63?substr($post_title,0,60 ).'&hellip;':$post_title;?></h1>
        ...
        <?php if ($display_breadcrumb == '1' && $title_bar_type != 2 && $title_bar_type != 3): ?>
            ...
            <?php else: ?>
            <?php peony_get_breadcrumb(array("before"=>"<div class='breadcrumb-nav text-light peony_display_breadcrumb'>".$breadcrumb_menu_prefix,
                                                "after"=>"</div>","show_browse"=>false,"separator"=>$breadcrumb_menu_separator)); ?>
            <?php endif ?>
        <?php endif;?>
        <?php endif;?>

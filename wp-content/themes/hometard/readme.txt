...
4. Use KingComposer to create your awesome page, home page, landing page... (follow the step 4 to set this page as home page)
4. Once you have this page ready you have to set it as homepage for your website. You can achieve it by going to WordPress dashboard -> Settings -> Reading -> Front page displays -> A static page (select below) and there select your newly created page.

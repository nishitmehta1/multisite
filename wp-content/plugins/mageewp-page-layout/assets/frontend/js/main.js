...
var mpl_front = (function ($) {
	...
	return {
		...
		video_background: function(selector) {
			...
			var myYoutubePlayer;
			$(youtube_selector).each(function () {
				myYoutubePlayer = $(this).YTPlayer();
				$(this).on("YTPReady", function (e) {
			...
			var myVimeoPlayer;
			$(vimeo_selector).each(function () {
				myVimeoPlayer = $(this).vimeo_player();
				$(this).on("VPReady", function (e) {
					$(this).parent().css('background', 'none');
					$(this).parent().find("section").css('background', 'none');
					$(this).parent().find("#video-controls").show();
					$(this).parent().find(".mpl-banner-bgimage").css('background', 'none');
			...
			var myHtml5Player;
			$(html5_selector).each(function () {
				myHtml5Player = $(this).html5_video_player();
				$(this).on("HVPReady", function (e) {
					$(this).parent().css('background', 'none');
					$(this).parent().find("section").css('background', 'none');
					$(this).parent().find("#video-controls").show();
					$(this).parent().find(".mpl-banner-bgimage").css('background', 'none');
		...
		animate: function(selector) {
			...
			$(selector).each(function () {
				var el = $(this);
				var clazz = $(this).get(0).className,
					delay = 0,
					speed = '2s',
					timeout = 0;

...
$mpl->add_map(
	array(
		'mpl_section_contact_4' => array(

			'name' => __('Contact 4', 'mageewp-page-layout'),
			'description' => '',
			'icon' => 'mpl-icon-contact-4',
			'category' => '',
			'params' => array(
				'general' => array(
					...
					array(
						...
						'options'		=> array(
							array(
								...
								'Button' => array(
									array('property' => 'background-color', 'label' => __( 'Color','mageewp-page-layout'),'value'=>'#8bc03c', 'selector' => '.mpl-contact-form #submit'),
								),
								//Background group
								'Background' => array(
